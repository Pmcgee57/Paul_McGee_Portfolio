...
#### We're going to take the top five athletes for our team from the dataframe we created by assigning the weights. Once we have our team, let's have a look at their stats.
```{r, results="hide"}
